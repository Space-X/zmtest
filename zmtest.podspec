#
#  Be sure to run `pod spec lint zmtest.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "dichao" => "158566751@qq.com" }
  # Or just: s.author    = "dichao"
  # s.authors            = { "dichao" => "158566751@qq.com" }
  # s.social_media_url   = "http://twitter.com/dichao"
